...
public class PopAreaAdapter extends HsBaseAdapter<CountryListBean>{
    public PopAreaAdapter(List<CountryListBean> list, Context context) {
        super(list, context);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        tv.setText(mList.get(i).SCOUNTRYNAME);
        return view;
    }
}
