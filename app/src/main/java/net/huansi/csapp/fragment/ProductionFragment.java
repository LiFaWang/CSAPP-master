...
public class ProductionFragment extends BaseFragment {
    ...
    public void init() {
        ...
        mFragmentProductionBinding.btnSelector.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mFragmentProductionBinding.btnSelector.getText().toString().equals(getString(R.string.btn_selector_by_date))) {
                    ...
                    mProductionFragmentAdapter.notifyDataSetChanged();
                    mFragmentProductionBinding.btnSelector.setText(getString(R.string.btn_selector_by_order));
                } else if (mFragmentProductionBinding.btnSelector.getText().toString().equals(getString(R.string.btn_selector_by_order))) {
                    ...
                    mProductionFragmentBeanList.clear();
                    mProductionFragmentAdapter.notifyDataSetChanged();
                    mFragmentProductionBinding.btnSelector.setText(getString(R.string.btn_selector_by_date));
                }
            }
        });
        mFragmentProductionBinding.btnDateSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mFragmentProductionBinding.tvArea.getText().toString().equals(getString(R.string.tv_area)) || mFragmentProductionBinding.tvFactory.getText().toString().equals(getString(R.string.tv_factory))) {
...
//                super.error(hsWebInfo, context);
                ...
                OthersUtil.ToastMsg(getContext(), "没有返回数据！");
            }
        });
    }
    ...
    private void setData() {
        ...
        mFragmentProductionBinding.tvFactory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mFragmentProductionBinding.tvArea.getText().toString().equals(getString(R.string.tv_area))) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (resultCode) {
            case RESULT_PRODUCTION:
                ...
                SPUtils.saveSpData(getContext(), "mTEndTime", mTStartTime);
