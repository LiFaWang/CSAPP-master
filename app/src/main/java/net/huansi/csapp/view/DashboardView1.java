...
public class DashboardView1 extends View {
    ...
    public int mRadius; // 扇形半径
    public int mStartAngle = 180; // 起始角度
    public int mSweepAngle = 180; // 绘制角度
    public int mMin = 0; // 最小值
    public int mMax = 100; // 最大值
    public int mSection = 10; // 值域（mMax-mMin）等分份数
    public int mPortion = 10; // 一个mSection等分份数
    public String mHeaderText = "℃"; // 表头
    public int mRealTimeValue = mMin; // 实时读数
    public boolean isShowValue = true; // 是否显示实时读数
    public int mStrokeWidth; // 画笔宽度
    public int mLength1; // 长刻度的相对圆弧的长度
    public int mLength2; // 刻度读数顶部的相对圆弧的长度
    public int mPLRadius; // 指针长半径
